...
//        float labelInterval = 25f;
        ...
        for (int i = 0; i < labels.length; i++) {
            float lines = i * mAxisLabelPaint.getTextSize();
            Utils.drawXAxisValue(c, labels[i], x, y + lines, mAxisLabelPaint, anchor, angleDegrees);
        }

//        if (labels.length > 1) {
//            Utils.drawXAxisValue(c, labels[0], x, y, mAxisLabelPaint, anchor, angleDegrees);
//            Utils.drawXAxisValue(c, labels[1], x, y + labelHeight + labelInterval, mAxisLabelPaint, anchor, angleDegrees);
//        } else {
//            Utils.drawXAxisValue(c, formattedLabel, x, y, mAxisLabelPaint, anchor, angleDegrees);
//        }
    }
