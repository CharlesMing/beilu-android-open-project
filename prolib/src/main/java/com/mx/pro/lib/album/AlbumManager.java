...
public final class AlbumManager {
    ...
    private AlbumManager(Fragment fragment) {
        this(fragment.getActivity(), fragment);
    }

    private AlbumManager(Activity activity, Fragment fragment) {
     ...
     */
    public static AlbumManager from(Activity activity) {
     ...
     * @return Matisse instance.
     */
    public static AlbumManager from(Fragment fragment) {
        return new AlbumManager(fragment);
    }
