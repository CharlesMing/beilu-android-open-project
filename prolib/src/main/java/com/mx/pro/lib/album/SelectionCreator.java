...
import com.mx.pro.lib.album.listener.OnCheckedListener;
import com.mx.pro.lib.album.listener.OnSelectedListener;
import com.mx.pro.lib.album.ui.AlbumActivity;
...
public final class SelectionCreator {
    private final AlbumManager mMatisse;
     ...
     */
    SelectionCreator(AlbumManager matisse, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
        mMatisse = matisse;
     ...
     * <p>
     * It's a redundant API with {@link AlbumManager#obtainResult(Intent)},
