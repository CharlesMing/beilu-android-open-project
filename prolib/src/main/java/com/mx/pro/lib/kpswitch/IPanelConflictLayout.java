 ...
 */
package com.mx.pro.lib.kpswitch;
...
public interface IPanelConflictLayout {
     ...
     * Keyboard->Panel
     *
     * @see com.mx.pro.lib.kpswitch.util.KPSwitchConflictUtil#showPanel(android.view.View)
     */
    void handleShow();
     ...
     * Panel->Keyboard
     *
     * @see com.mx.pro.lib.kpswitch.util.KPSwitchConflictUtil#showKeyboard
     */
    void handleHide();
     ...
     * @see com.mx.pro.lib.kpswitch.handler.KPSwitchPanelLayoutHandler#resetToRecommendPanelHeight
     * @see com.mx.pro.lib.kpswitch.util.KeyboardUtil#getValidPanelHeight(android.content.Context)
     */
