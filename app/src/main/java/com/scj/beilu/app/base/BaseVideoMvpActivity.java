...
public abstract class BaseVideoMvpActivity<V extends MvpView, P extends MvpPresenter<V>, Player extends GSYBaseVideoPlayer>
        extends VideoMvpActivity<V, P, Player> implements MvpView, Toolbar.OnMenuItemClickListener {
