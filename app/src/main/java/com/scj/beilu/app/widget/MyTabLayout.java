...
public class MyTabLayout extends HorizontalScrollView {
    ...
    class TabView extends LinearLayout {
        ...
        public TabView(Context context) {
            ...
            mCustomLine = new Paint();
            mCustomLine.setColor(Color.BLUE);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            // TODO: 2019/5/15
            if (isSelected()) {
                Logger.e(mTextViewWidth + "============" + getHeight());
//                canvas.drawRect(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight,
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
                canvas.drawRect(0, getHeight()-10, mTextViewWidth, getHeight()/2, mCustomLine);
            }
        }
        ...
        public void onMeasure(final int origWidthMeasureSpec, final int origHeightMeasureSpec) {
            ...
            if (mCustomView != null) {
                mTextView = mCustomView.findViewById(R.id.tv_tab_item);
                if (mTextView != null) {
                    mTextViewWidth = mTextView.getWidth();
                }
            }
        }
...
//            }
    ...
    public class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(final int position) {
            final MyTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null && getSelectedTabPosition() != position
