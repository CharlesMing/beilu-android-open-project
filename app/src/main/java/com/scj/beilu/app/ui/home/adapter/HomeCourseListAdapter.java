 ...
 */
public class HomeCourseListAdapter extends RecyclerView.Adapter<HomeCourseListAdapter.CourseViewHolder> {
    ...
    public HomeCourseListAdapter(SupportFragment fragment) {
    ...
    public CourseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_home_page_course_content, parent, false);
