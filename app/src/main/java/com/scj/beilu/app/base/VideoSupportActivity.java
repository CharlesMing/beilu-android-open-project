...
/**
 * @author Mingxun
 * @time on 2019/3/25 22:56
 */
public abstract class VideoSupportActivity<T extends GSYBaseVideoPlayer> extends SupportActivity
    ...
    public void showFull() {
        ...
        getGSYVideoPlayer().startWindowFullscreen(VideoSupportActivity.this, hideActionBarWhenFull(), hideStatusBarWhenFull());
